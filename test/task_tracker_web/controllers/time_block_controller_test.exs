defmodule TaskTrackerWeb.Time_blockControllerTest do
  ...
  @create_attrs %{
    ...
    init_time: "2010-04-17 14:00:00.000000Z"
  }
  @update_attrs %{
    end_time: "2011-05-18 15:01:01.000000Z",
    init_time: "2011-05-18 15:01:01.000000Z"
  }
  @invalid_attrs %{end_time: nil, init_time: nil}

  def fixture(:time_block) do
    {:ok, time_block} = Time_blocks.create_time_block(@create_attrs)
    time_block
  end
  ...
  describe "update time_block" do
    ...
    test "renders time_block when data is valid", %{conn: conn, time_block: %Time_block{id: id} = time_block} do
